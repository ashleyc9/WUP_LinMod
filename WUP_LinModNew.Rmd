...
The residual standard error is 1.226, while the r-squared is 0.4706. The comparison between the two, we always look at the adjusted r-squared numbers. As you put more data in your model, the adjusted r-squared will go up. 
...
The residual standard error is 1.295 and the r-squared is 0.4094. SIMS~ARM has a better residual error and a better r-squared number than SIMS~GRIP. 
...
This model has a residual standard error of 1.144 and a r-squared of 0.5422. This model has a better residual error than SIMS~GRIP and SIMS~ARM. Model is SIMS= .037311 * ARM + .024470 * GRIP - 5.433871
...
The p value is a lot smaller than model.1,model.3 . There is a big difference between the data models. Model 3 is better than model 1 and models 3 is better than model 2. That is all based on looking at the p values between the models.
